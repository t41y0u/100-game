...
const { PREFIX, npm_package_version, npm_package_repository_url } = process.env;
...
export default class extends Command {
    ...
    async exec(message: Message) {
        ...
        const embed = this.client.embeds
            ...
            .setDescription(`I'm a bot made to play a game called "Race to 100". Check out ${PREFIX}rules for how to play`)
            .addField('❯ Discord', [
